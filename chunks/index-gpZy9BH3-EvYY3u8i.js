import { A as onBeforeUnmount, C as getCurrentInstance, G as withDirectives, H as watch, I as renderSlot, M as onUnmounted, N as openBlock, O as nextTick, S as defineComponent, ct as normalizeStyle, d as Teleport, f as computed, g as createElementBlock, h as createCommentVNode, j as onMounted, l as withModifiers, lt as toDisplayString, m as createBlock, ot as unref, p as createBaseVNode, s as vShow, st as normalizeClass, tt as ref, u as Fragment } from "./_plugin-vue_export-helper-DCRN0gge.js";
import { a as Us, d as mo$1, g as zl, i as Pl, l as fo$1, m as uo$1, n as Dn, o as Ys, p as qo, s as Z, t as Ba, u as mn } from "./sidepanel-Dkv1_Hg3.js";
//#region ../../node_modules/.pnpm/markstream-vue@0.0.3-beta.5_vue@3.5.41_typescript@5.9.3_/node_modules/markstream-vue/dist/index-gpZy9BH3.js
...
var be = (f, s) => {
	for (var i in s || (s = {})) Nt.call(s, i) && We(f, i, s[i]);
	if (je) for (var i of je(s)) zt.call(s, i) && We(f, i, s[i]);
	return f;
};
var Ce = (f, s) => Dt(f, $t(s));
...
var Kt = { class: "html-preview-frame__header" };
var Jt = { class: "html-preview-frame__title" };
var Qt = { class: "html-preview-frame__label" };
var Zt = ["srcdoc"];
var to = /* @__PURE__ */ Z(/* @__PURE__ */ defineComponent({
	...
	setup(f) {
		const s = f, { t: i } = mo$1(), q = computed(() => {
			...
			if (w.startsWith("<!doctype") || w.startsWith("<html") || w.startsWith("<body")) return L;
			return `<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    ...
    <style>
      html, body {
        ...
        padding: 0;
        height: 100%;
        background-color: ${s.isDark ? "#020617" : "#ffffff"};
        color: ${s.isDark ? "#e5e7eb" : "#020617"};
      }
      body {
  ...
  <body>
    ${L}
		...
		return onMounted(() => {
		...
		}), (L, w) => (openBlock(), createBlock(Teleport, { to: "body" }, [createBaseVNode("div", {
			...
			onClick: w[1] || (w[1] = withModifiers(() => {}, ["stop"]))
		}, [createBaseVNode("div", Kt, [createBaseVNode("div", Jt, [w[3] || (w[3] = createBaseVNode("span", { class: "html-preview-frame__dot" }, null, -1)), createBaseVNode("span", Qt, toDisplayString(s.title || unref(i)("common.preview") || "Preview"), 1)]), createBaseVNode("button", {
			type: "button",
		...
		}, " × ", 2)]), createBaseVNode("iframe", {
			class: "html-preview-frame__iframe",
			sandbox: "allow-scripts allow-same-origin",
			srcdoc: q.value
		}, null, 8, Zt)], 2)], 2)]));
	}
}), [["__scopeId", "data-v-3cf0ed56"]]);
var oo = {
	key: 0,
...
var no = { class: "flex items-center space-x-2 flex-1 overflow-hidden" };
var io = ["innerHTML"];
var lo = { class: "text-sm font-medium font-mono truncate" };
var ao = { class: "flex items-center space-x-2" };
var ro = ["aria-pressed"];
var so = ["disabled"];
var uo = ["disabled"];
var co = ["disabled"];
...
var wo = ["aria-label"];
var yo = { class: "code-loading-placeholder" };
var ko = {
	class: "sr-only",
	"aria-live": "polite",
	role: "status"
};
var Je = "__markstreamMonacoPassiveTouch__";
var Qe = 10;
var Ze = 36;
var et = 1;
var tt = 0;
var ot = 1.5;
var ue = 1;
var Se = /* @__PURE__ */ Z(/* @__PURE__ */ defineComponent({
	...
	setup(f, { emit: s }) {
		...
		function w(t) {
			return t == null ? { passive: !0 } : typeof t == "boolean" ? {
				capture: t,
				passive: !0
			} : typeof t == "object" ? "passive" in t ? t : Ce(be({}, t), { passive: !0 }) : { passive: !0 };
		}
		const O = getCurrentInstance(), x = computed(() => {
			const t = O == null ? void 0 : O.vnode.props;
			return !!(t && (t.onPreviewCode || t.onPreviewCode));
		}), { t: c } = mo$1(), b = ref(null), ce = ref(null), X = ref(!1), D = ref(qo(i.node.language)), K = computed(() => Pl(D.value)), M = ref(!1), B = ref(!1), te = ref(!1), He = ref(!1), j = ref(null);
		let de = 0;
		const rt = fo$1(), J = ref(null), I = ref(typeof window == "undefined");
		typeof window != "undefined" && watch(() => ce.value, (t) => {
			var o;
		...
		let V = null, oe = null, fe = () => {}, ve = () => {}, ne = () => null, z = () => ({
		...
		const T = computed(() => i.node.diff), ge = ref(!1), le = ref(!1);
		typeof window != "undefined" && R(null, null, function* () {
			try {
				...
				if (typeof o == "function" && (Pe = o), typeof e == "function") {
					const n = ze();
					if (n && i.themes && Array.isArray(i.themes) && !i.themes.includes(n)) throw new Error("Preferred theme not in provided themes array");
					const l = e(Ce(be({
						wordWrap: "on",
						wrappingIndent: "same",
						themes: i.themes,
						theme: n
					}, i.monacoOptions || {}), { onThemeChange() {
						vt();
					} }));
		...
		const H = ref(typeof ((_e = i.monacoOptions) == null ? void 0 : _e.fontSize) == "number" ? i.monacoOptions.fontSize : NaN), v = ref(H.value), st = computed(() => {
		...
		function we() {
			var e;
			if (Number.isFinite(v.value) && v.value > 0 && Number.isFinite(H.value)) return v.value;
			const t = Le();
		...
		function Oe() {
			...
			try {
				...
				if (T.value && u != null && u.getOriginalEditor && u != null && u.getModifiedEditor) {
					...
					if (Ye > 0) return Math.ceil(Ye + ue);
		...
		function vt() {
			...
			if (l && a) return e.style.setProperty("--vscode-editor-foreground", l.trim()), e.style.setProperty("--vscode-editor-background", a.trim()), e.style.setProperty("--vscode-editor-selectionBackground", h.trim()), !0;
		}
		function W() {
			try {
				const t = b.value;
		...
		const ye = computed(() => i.isShowPreview && (D.value === "html" || D.value === "svg")), Z = computed(() => D.value === "mermaid");
		watch(() => i.node.language, (t) => {
			D.value = qo(t);
		}), watch(() => i.node.code, (t) => R(null, null, function* () {
			var e, o;
			if (i.stream !== !1) {
				if (D.value || (D.value = qo(Pe(t))), V && !te.value && b.value) try {
					yield ke(b.value);
				} catch (n) {}
		...
		const ht = computed(() => {
			const t = D.value;
			return t ? Us[t] || t.charAt(0).toUpperCase() + t.slice(1) : Us[""] || "Plain Text";
		}), gt = computed(() => Ys(D.value || "")), pt = computed(() => {
			const t = {}, e = (l) => {
				if (l != null) return typeof l == "number" ? `${l}px` : String(l);
		...
		function P(t, e, o = "top") {
			if (De(t.currentTarget)) return;
			const n = t, l = (n == null ? void 0 : n.clientX) != null && (n == null ? void 0 : n.clientY) != null ? {
				x: n.clientX,
				y: n.clientY
			} : void 0;
			Dn(t.currentTarget, e, o, !1, l, i.isDark);
		}
		function S() {
			uo$1();
		}
		function $e(t) {
			if (De(t.currentTarget)) return;
			const e = X.value ? c("common.copied") || "Copied" : c("common.copy") || "Copy", o = t, n = (o == null ? void 0 : o.clientX) != null && (o == null ? void 0 : o.clientY) != null ? {
				x: o.clientX,
				y: o.clientY
			} : void 0;
			Dn(t.currentTarget, e, "top", !1, n, i.isDark);
		}
		function yt() {
			M.value = !M.value;
		...
		function bt(t) {
			return R(this, null, function* () {
				...
				const e = T.value ? $() : z();
				if (typeof ((l = i.monacoOptions) == null ? void 0 : l.fontSize) == "number") e == null || e.updateOptions({
					fontSize: i.monacoOptions.fontSize,
					automaticLayout: !1
				}), H.value = i.monacoOptions.fontSize, v.value = i.monacoOptions.fontSize;
				else {
					const a = Le();
					a && a > 0 ? (H.value = a, v.value = a) : (H.value = 12, v.value = 12);
				}
				!M.value && !B.value && U(), i.loading === !1 && (yield nextTick(), Ba(() => {
		...
		const Bt = watch(() => [i.monacoOptions, I.value], () => {
			var o, n;
			if (!V || !I.value) return;
			if (Z.value) return Bt();
		...
		}, { deep: !0 }), re = watch(() => [i.loading, I.value], (o) => R(null, [o], function* ([t, e]) {
			if (e) {
				if (Z.value) {
					nextTick(() => {
						re == null || re();
		...
		return onUnmounted(() => {
			...
			class: normalizeClass(["code-block-container my-4 rounded-lg border overflow-hidden shadow-sm", [i.isDark ? "border-gray-700/30 bg-gray-900" : "border-gray-200 bg-white", {
				"is-rendering": i.loading,
				"is-dark": i.isDark
			}]])
		}, [
			i.showHeader ? (openBlock(), createElementBlock("div", oo, [renderSlot(t.$slots, "header-left", {}, () => [createBaseVNode("div", no, [createBaseVNode("span", {
				class: "icon-slot h-4 w-4 flex-shrink-0",
				innerHTML: gt.value
			}, null, 8, io), createBaseVNode("span", lo, toDisplayString(ht.value), 1)])], !0), renderSlot(t.$slots, "header-right", {}, () => [createBaseVNode("div", ao, [
				createBaseVNode("button", {
					...
					viewBox: "0 0 24 24",
					class: "w-3 h-3"
				}, [...e[17] || (e[17] = [createBaseVNode("path", {
					fill: "none",
					stroke: "currentColor",
				...
				i.showFontSizeButtons && i.enableFontSizeControl ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
					...
					createBaseVNode("button", {
						...
						"stroke-linejoin": "round",
						"stroke-width": "2"
					}, [createBaseVNode("path", { d: "M3 12a9 9 0 1 0 9-9a9.75 9.75 0 0 0-6.74 2.74L3 8" }), createBaseVNode("path", { d: "M3 3v5h5" })])], -1)])], 40, uo),
					createBaseVNode("button", {
						type: "button",
						class: "code-action-btn p-2 text-xs rounded-md transition-colors hover:bg-[var(--vscode-editor-selectionBackground)]",
				...
				i.showCopyButton ? (openBlock(), createElementBlock("button", {
					...
					onMouseleave: S,
					onBlur: S
				}, [X.value ? (openBlock(), createElementBlock("svg", mo, [...e[22] || (e[22] = [createBaseVNode("path", {
					fill: "none",
					stroke: "currentColor",
					"stroke-linecap": "round",
					"stroke-linejoin": "round",
					"stroke-width": "2",
					d: "M20 6L9 17l-5-5"
				}, null, -1)])])) : (openBlock(), createElementBlock("svg", vo, [...e[21] || (e[21] = [createBaseVNode("g", {
					fill: "none",
					stroke: "currentColor",
					"stroke-linecap": "round",
					"stroke-linejoin": "round",
					...
					rx: "2",
					ry: "2"
				}), createBaseVNode("path", { d: "M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2" })], -1)])]))], 40, fo)) : createCommentVNode("", !0),
				i.showExpandButton ? (openBlock(), createElementBlock("button", {
					...
					onMouseleave: S,
					onBlur: S
				}, [M.value ? (openBlock(), createElementBlock("svg", go, [...e[23] || (e[23] = [createBaseVNode("path", {
					fill: "none",
					stroke: "currentColor",
					"stroke-linecap": "round",
					"stroke-linejoin": "round",
				...
				}, null, -1)])])) : (openBlock(), createElementBlock("svg", po, [...e[24] || (e[24] = [createBaseVNode("path", {
					fill: "none",
					stroke: "currentColor",
					"stroke-linecap": "round",
					"stroke-linejoin": "round",
				...
				}, null, -1)])]))], 40, ho)) : createCommentVNode("", !0),
			...
			withDirectives(createBaseVNode("div", yo, [renderSlot(t.$slots, "loading", {
				loading: f.loading,
				stream: f.stream
